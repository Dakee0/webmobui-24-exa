...
var _annonceElement = require("./elements/annonce-element");
var _categorieElement = require("./elements/categorie-element");
    ...
    switch(hashs[0]){
        case "#latest":
            if (hashs[1]) {
                ...
                (0, _annoncesJs.displayDetailsAnnonce)(hashs[1]);
            } else {
                (0, _helpersJs.displaySection)("annonces");
                (0, _annoncesJs.displayAnnonces)();
            }
            break;
        case "#categories":
            if (hashs[1]) {
                (0, _helpersJs.displaySection)("annonces");
                (0, _annoncesJs.displayAnnoncesCategories)(hashs[1]);
            } else {
        ...
        case "#account":
            ...
            (0, _annoncesJs.displayStarredAnnonces)();
            break;
    }
};
...
routeur();
navigator.serviceWorker.register(require("b895d434c1070bba"));

},{"./elements/annonce-element":"iu24S","./elements/categorie-element":"fYZoA","./helpers.js":"ecN5O","./sections/annonces.js":"hmPsh","./sections/categories.js":"ik6tC","b895d434c1070bba":"9U48Y"}],"iu24S":[function(require,module,exports) {
...
},{}],"fYZoA":[function(require,module,exports) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayAnnonces", ()=>displayAnnonces);
parcelHelpers.export(exports, "displayAnnoncesCategories", ()=>displayAnnoncesCategories);
parcelHelpers.export(exports, "displayDetailsAnnonce", ()=>displayDetailsAnnonce);
parcelHelpers.export(exports, "displayStarredAnnonces", ()=>displayStarredAnnonces);
...
const displayAnnonces = ()=>(0, _api.loadAnnonces)().then((annonces)=>{
        //Vide la liste
        ...
        annonces.forEach((annonce)=>{
            ...
            if ((0, _localStorageJs.getItem)(annonce.id)) newElement.setAttribute("starred", true);
            newElement.addEventListener("starred_click", ()=>{
                if ((0, _localStorageJs.getItem)(annonce.id)) {
                    console.log("on l'enl\xe8ve");
                    (0, _localStorageJs.removeItem)(annonce.id);
                } else {
                    console.log("on l'ajoute");
                    (0, _localStorageJs.setItem)(annonce.id, annonce);
                }
                newElement.setAttribute("starred", !!(0, _localStorageJs.getItem)(annonce.id));
            });
            annoncesList.appendChild(newElement);
            sectionTitle.innerHTML = `Derni\xe8res annonces INSERER CHIFFRES`;
        });
    });
const displayAnnoncesCategories = (id)=>{
    (0, _api.loadAnnoncesCategories)(id).then((annonces)=>{
        annoncesList.replaceChildren();
        annonces.forEach((annonce)=>{
            const newElement = document.createElement("annonce-element");
            newElement.setAttribute("href", `#latest-${annonce.id}`);
            ...
            annoncesList.appendChild(newElement);
            sectionCategories.innerHTML = `Cat\xe9gories > NOM CAT & INSERER CHIFFRES`;
        });
    });
};
const displayDetailsAnnonce = (id)=>{
    (0, _api.loadAnnonce)(id).then((annonce)=>{
...
const displayStarredAnnonces = ()=>{
    const annonces = (0, _localStorageJs.getItems)();
    ...
    annonces.forEach((annonce)=>{
        ...
        annoncesList.appendChild(newElement);
        sectionCategories.innerHTML = "Int\xe9ressant INSERT NOMBRE";
    });
};

},{"../api":"8Zgej","../local-storage.js":"EAMLy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8Zgej":[function(require,module,exports) {
...
parcelHelpers.export(exports, "loadAnnoncesCategories", ()=>loadAnnoncesCategories);
...
const sectionCategories = document.querySelector("#section-categories h4");
const displayCategories = ()=>(0, _api.loadCategories)().then((categories)=>{
        //Vide la liste
        ...
        categories.forEach((categorie)=>{
            ...
            sectionCategories.innerHTML = `Cat\xe9gories`;
        });
    });

},{"../api":"8Zgej","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9U48Y":[function(require,module,exports) {
module.exports = require("da98cd7902895f7a").getBundleURL("bLxZJ") + "worker.js" + "?" + Date.now();

},{"da98cd7902895f7a":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequiref161")
